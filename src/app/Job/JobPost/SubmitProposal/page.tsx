...
export default function SubmitProposal() {
  ...
  const { numberOfMilestones, milestoneDuration, amountForMilestone } =
    formData;
  ...
  return (
    <div>
      ...
      <div className="pb-20 pt-10">
        <div className="max-w-screen-md mx-auto border rounded-lg py-10">
          <h1 className="px-8 text-2xl mb-2 font-medium">Terms</h1>
          ...
          <h1 className="mt-5 px-8">How do you want to be paid?</h1>
          <div className="px-8 py-10 flex justify-evenly items-center">
            <label htmlFor="">
              <input
                type="radio"
