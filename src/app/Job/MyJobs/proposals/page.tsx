...
export default function Proposals() {
  ...
  return (
    <>
      <Navbar />
      <div className="px-6">
        <div className="pb-2 mt-16 text-center border-b-[1.5px] border-slate-700 mb-4">
          <nav className="md:w-2/5">
            <ul className="w-3/5 md:w-full flex justify-between flex-wrap leading-loose">
              <li>
                <button className={`active:bg-[#00EF8B]`}>All Proposals ({proposals.length})</button>
              </li>
              <li>
                <button>Shortlisted ({shortlist.length})</button>
              </li>
              <li>
